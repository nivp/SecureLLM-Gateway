...
const secretRules = [
  { id: "openai-key", pattern: /\bsk-[A-Za-z0-9_-]{20,}\b/g, message: "OpenAI-style secret detected" },
  { id: "jwt", pattern: /\beyJ[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}\b/g, message: "JWT-shaped token detected" },
  { id: "aws-access-key", pattern: /\bAKIA[0-9A-Z]{16}\b/g, message: "AWS access key detected" }
];
